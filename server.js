...
app.use('/api', require('./routes/flutterwave'));
...
app.use('/api/admin', require('./routes/admin')); // ✅ Admin route confirmed
...
app.get('/healthz', (req, res) => {
  res.status(200).json({ status: 'ok', message: 'Render health check passed' });
});
